...
| 02 The approach | "Own your journey", then see clearly → choose strategically → move deliberately | Row 24. Heading stays hers (the call approved it). Step headings are Kumar's three verbs, restored 2026-09-16 at Shuja's request. Her own words stay inside the copy: striving in 01, positive action and "a real world roadmap" in 03, which is where row 25 puts it. Presented in concept 2's statement band, carried over the same day and rebuilt in this concept's aubergine and Georgia |
